  ...
  forbidden: [
    {
      ...
      comment:
        'The domain should not access other layers outside of the domain',
      severity: 'error',
      from: { path: 'domain' },
      to: { pathNot: 'domain' },
    },
    {
      name: 'application-accessing-insfrastructure',
      comment:
        'The application should not access the infrastructure layer directly',
      severity: 'error',
      from: { path: 'presentation' },
      to: { path: 'infrastructure' },
    },
    /* Rules from the 'recomended' preset: */
    {
      name: 'no-circular',
      severity: 'warn',
      comment:
...
// generated: dependency-cruiser@15.5.0 on 2023-12-24T16:49:11.052Z
